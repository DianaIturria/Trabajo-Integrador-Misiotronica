...
function Contact() {
  ...
  const handleFormSubmit = (event) => {
    ...
    // Aquí puedes realizar acciones adicionales, como enviar los datos a un servidor backend (que no tienes en este momento) o guardarlos en el almacenamiento local del navegador.
  ...
  return (
    ...
    <div className='contact-container'>
      <div className='contact-text'>
        <p>Si tenés alguna consulta, sugerencia o simplemente querés conocer más sobre nuestros productos y servicios, no dudes en ponerte en contacto con nosotros</p>
